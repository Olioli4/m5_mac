...
ssh $MAC_HOST "export PATH=/usr/local/bin:/usr/local/opt/automake/bin:/usr/local/opt/libtool/bin:`$PATH && cd $REMOTE_DIR && $FLUTTER pub get"
...
ssh $MAC_HOST "export PATH=/usr/local/bin:/usr/local/opt/automake/bin:/usr/local/opt/libtool/bin:`$PATH && cd $REMOTE_DIR && $FLUTTER build macos --release"
